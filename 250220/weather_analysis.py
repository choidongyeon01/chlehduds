# -*- coding: utf-8 -*-
"""
Created on Thu Feb 20 12:37:43 2025
...
dust = pd.read_excel('데이터/환경 관련 데이터/dust.xlsx')
weather = pd.read_excel('데이터/환경 관련 데이터/weather.xlsx')
...
# 산점 그래프로 시각화2 : # 미세먼지와 초미세먼지의 상관관계
plt.figure(figsize = (15, 10))
x = df['PM10']
y = df['PM2.5']
